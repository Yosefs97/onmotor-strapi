...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    externalImageUrls: Schema.Attribute.Text;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Values: Schema.Attribute.Enumeration<
      ['guide-tech', 'guide-beginner', 'guide-buy', 'guide-advanced']
    >;
  };
}
...
export interface ApiProssPross extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::pross.pross'> &
      Schema.Attribute.Private;
    mediaUrl: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'title_pros'>;
    tag_name: Schema.Attribute.String;
    title_pros: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiSidebarMiddleSidebarMiddle
  ...
  info: {
    displayName: 'Sidebar Middle';
    pluralName: 'sidebar-middles';
    singularName: 'sidebar-middle';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::sidebar-middle.sidebar-middle'
    > &
      Schema.Attribute.Private;
    mediaUrl: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
